...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        fileGroupBox->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        cameraGroupBox->setGeometry(QRect(940, 210, 571, 201));
        cameraGroupBox->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        objectGroupBox->setGeometry(QRect(940, 410, 571, 481));
        objectGroupBox->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        objectListWidget->setSelectionMode(QAbstractItemView::SelectionMode::ExtendedSelection);
