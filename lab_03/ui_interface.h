...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphicsView->setGeometry(QRect(0, 10, 910, 810));
        loadGroupBox = new QGroupBox(centralwidget);
        loadGroupBox->setObjectName("loadGroupBox");
        loadGroupBox->setGeometry(QRect(920, 0, 560, 201));
        ...
        cameraGroupBox->setGeometry(QRect(920, 210, 571, 201));
        ...
        objectGroupBox->setGeometry(QRect(920, 410, 571, 411));
        ...
        objectDeletePushbutton->setGeometry(QRect(330, 80, 191, 27));
        ...
        objectCompositePushbutton->setGeometry(QRect(330, 40, 191, 27));
        ...
        undoLastTransformPushbutton->setGeometry(QRect(330, 120, 191, 27));
        ...
        toggleFaceCullingPushbutton->setGeometry(QRect(330, 160, 191, 27));
        objectListWidget = new QListWidget(objectGroupBox);
        objectListWidget->setObjectName("objectListWidget");
        objectListWidget->setGeometry(QRect(10, 30, 281, 181));
        objectListWidget->setSelectionMode(QAbstractItemView::MultiSelection);
